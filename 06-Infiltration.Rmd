...
Using results from CIBERSORT abs mode as an example, we provide two other functions to perform inter- or intra sample comparison.  The phenotype used for comparison is the one identified in the config.yaml cohort parameter section.  This section is described more in Chapter 4.2.1.
