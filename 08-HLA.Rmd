...
The we identify the HLA allele using extracted reads:
```
...
RIMA also use arcasHLA to merge individual HLA results and below is the result of merged HLAs.
```
