...
#Note: You will need to install miniconda3 into the RIMA directory.  If you have conda installed elsewhere, you will still need a local copy in your RIMA directory in order for the environment installation shell program to work.  (see below)
