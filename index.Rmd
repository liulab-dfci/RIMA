...
Currently, RIMA supports **hg38**.   ###is this true for all platforms?  (AWS, GCP and HCS?)
...
rseqc_ref: house_keeping  #option: 'house_keeping' or 'false'. By default, a subset of housekeeping genes is used by rseqc to assess alignment quality.  This reduces the amlunt of time needed to run rseqc.  
...
Treatment: R
Control: NR
batch: syb_batch          #option: false or a column name from the metasheet.csv.  If set to a column name in the metasheet.csv, the column name will be used as a covariate for differential analysis (DeSeq2) to account for batch effect.  
